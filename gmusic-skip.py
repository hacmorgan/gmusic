...
if desiredPlaylistIndex != -1:
    ...
    if reversedPlaylistIndex != -1:
        ...
        print('The ' + desiredPlaylist + ' playlist has been reversed, updating it now') 
    ...
    while numSongs > 0:
        ...
        revDicto = reversedTrackDict[i]
        
        try:
            subDict = dicto['track']
            try:
                subRevDict = revDicto['track']
                if subDict['storeId'] == subRevDict['storeId']:
                    break
            except:
                pass
